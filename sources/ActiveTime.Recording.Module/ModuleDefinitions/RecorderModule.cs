...
namespace DustInTheWind.ActiveTime.Recording.Module.ModuleDefinitions
{
    public class RecorderModule : IModule
    {
        ...
        public void Initialize()
        {
            ...
            unityContainer.RegisterType<IRecorderService, RecorderService>(new ContainerControlledLifetimeManager());
